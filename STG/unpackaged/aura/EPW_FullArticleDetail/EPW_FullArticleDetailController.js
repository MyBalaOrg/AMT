({
    fetchContentDetails : function(component, event, helper) {
        ...
        //var hero_id = component.get("v.recordId");
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                if(response.getReturnValue()[0].Content_Type__c == 'Special Employee Advisory'){
                    	...
                    	component.set("v.SpecialEmployeeAdvisory", true);
                    }
                if(response.getReturnValue()[0].Content_Type__c == 'Employee Communication'){
                        component.set("v.displayHeaders", true);
                    	component.set("v.EmployeeCommunication", true);
                    }
