({
    ...
    **/
    populatePropertiesArray : function(component) {
        ...
        properties.push(component.get("v.askRichardSearch"));
        properties.push(component.get("v.askRichardSearchIcon"));
    ...
    **/
    getObjectRows : function(component, properties){
        ...
        action.setCallback(this, function(response){
            ...
            if (state === "SUCCESS") {
                ...
                if(output != null && (output.length < component.get("v.numberRecords"))) {
                    component.set("v.numberRecords", output.length);
                }
                //added to solve bug of not changing page number when clicked next button
                this.setPaginationParams(component);
            } else {
    ...
    setPaginationParams : function(component) {
        ...
        component.set("v.endPage", Math.ceil(value));
