({
    ...
    **/
    ...
    previous : function(component, event, helper) {
        component.set("v.currentPageNumber", component.get("v.currentPage")-1);
    ...
    currentPageChange : function(component, event, helper) {
        ...
        if(upperRange > component.get("v.numberRecords")){
            lowerRange = component.get("v.numberRecords")-1;
        }
    ...
    navigateToUrl : function(component, event, helper){
       window.open(component.get("v.askRichardSearch"),"_self"); 
               
    },
    
     navigateToIframe: function(component, event, helper){
    ...
    navigateToIframenewWindow: function(component, event, helper){
    ...
    pageSelect: function(component, event, helper){
        var clickedPage = parseInt(event.currentTarget.dataset.page);
        component.set("v.currentPageNumber", clickedPage);
        component.set("v.currentPage", clickedPage);
    },
